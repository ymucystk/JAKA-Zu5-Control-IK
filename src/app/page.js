...
export default function Home() {
  ...
  const joint_pos = {
    ...
    j2:{x:0,y:0.1201,z:0},
    j3:{x:0,y:0.43,z:0},
    j4:{x:0,y:0.36852,z:0},
    j5:{x:0.114001,y:0.113502,z:0},
    j6:{x:0,y:0,z:0},
    j7:{x:0,y:0,z:0.15},
  }

  const [target,set_target] = React.useState({x:0.3,y:0.5,z:0.3})
  ...
  const target15_update = (target15,wrist_direction,wrist_angle,target_move)=>{
    ...
    const {a:wk_teihen} = calc_side_1(p14_offset_distance,direction_offset)
    const {s:wk_syahen} = calc_side_2(wk_teihen,p14_offset_y)
...
const Assets = ()=>{
  return (
    <a-assets>
      {/*Model*/}
      <a-asset-items id="base" src="JAKA_Zu_5_BASE.gltf" ></a-asset-items>
      <a-asset-items id="j1" src="JAKA_Zu_5_J1.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="JAKA_Zu_5_J2.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="JAKA_Zu_5_J3.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="JAKA_Zu_5_J4.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="JAKA_Zu_5_J5.gltf" ></a-asset-items>
      <a-asset-items id="j6" src="JAKA_Zu_5_J6.gltf" ></a-asset-items>
    </a-assets>
  )
}
